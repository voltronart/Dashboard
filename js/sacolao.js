  ...
  lista.forEach((produto) => {
    ...
    card.innerHTML = `
      ...
      <div class="card-produto-admin-corpo">
        ...
        <p class="card-produto-admin-preco">${formatarPreco(produto.preco_sacolao)} / ${produto.unidade || "-"}</p>
...
function abrirModalEdicao(id) {
  ...
  document.getElementById("produto-preco").value = item.preco_sacolao;
...
async function salvarProduto(event) {
  ...
  try {
    ...
    const payload = {
      ...
      preco_sacolao: parseFloat(document.getElementById("produto-preco").value) || 0,
